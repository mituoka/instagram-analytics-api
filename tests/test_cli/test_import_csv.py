...
class TestParseArgs:
    ...
    def test_parse_args_custom_batch_size(self):
        ...
        with mock.patch(
            "sys.argv", ["import_csv.py", "--file", "test.csv", "--batch-size", "500"]
        ):
            args = parse_args()
            assert args.file == "test.csv"
...
class TestProcessCsvRow:
    ...
    def test_process_row_batch_commit(self):
        ...
        # バッチサイズに達した行数の処理
        with mock.patch(
            "cli.import_csv.commit_records", return_value=[]
        ) as mock_commit:
...
class TestImportCsv:
    ...
    def test_import_success(self, mock_csv_file):
        ...
        with mock.patch("cli.import_csv.SessionLocal") as mock_session:
            ...
            with mock.patch(
                "cli.import_csv.process_csv_file", return_value=True
            ) as mock_process:
    ...
    def test_import_io_error(self, mock_csv_file):
        ...
        with mock.patch("cli.import_csv.SessionLocal") as mock_session:
            ...
            with mock.patch(
                "cli.import_csv.process_csv_file", side_effect=IOError("IO Error")
            ) as mock_process:  # noqa: F841
                result = import_csv(mock_csv_file)
...
class TestMain:
    def test_main_success(self):
        ...
        with mock.patch("cli.import_csv.parse_args") as mock_parse_args:
            ...
            with mock.patch(
                "cli.import_csv.import_csv", return_value=True
            ) as mock_import:
    ...
    def test_main_failure(self):
        ...
        with mock.patch("cli.import_csv.parse_args") as mock_parse_args:
            ...
            with mock.patch(
                "cli.import_csv.import_csv", return_value=False
            ) as mock_import:  # noqa: F841
                with mock.patch("sys.exit") as mock_exit:
                    main()
